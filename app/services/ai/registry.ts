...
export const AI_PROVIDERS: AiProviderRegistry[] = [
  ...
  { id: "anthropic", label: "Anthropic", baseURL: "https://api.anthropic.com/v1", defaultModel: "claude-sonnet-4-5", modelEditable: true, keyHintUrl: "https://console.anthropic.com/settings/keys" },
